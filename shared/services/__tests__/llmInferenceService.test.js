...
const llmInferenceService_1 = require("../llmInferenceService");
jest.mock('openai', () => {
    return {
        __esModule: true,
...
describe('LLMInferenceService', () => {
    ...
    beforeEach(() => {
        ...
        service = new llmInferenceService_1.LLMInferenceService('test-api-key');
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
    describe('aggregateAnalysisData', () => {
        it('should correctly aggregate session data', () => {
            ...
            expect(aggregation.averageSessionLength).toBe(12.5);
...
//# sourceMappingURL=llmInferenceService.test.js.map