...
describe('AutoAnalyzeService Bot ID Fix', () => {
  ...
  test('should create separate instances for different bot IDs', () => {
    const optumBotId = 'st-17220bac-4b2e-5e1f-ab83-f8708ce87a8f';
    const compsychBotId = 'st-90549a67-7f19-5074-afcf-3120db51a26d';
  ...
  test('should reuse same instance for same bot ID', () => {
    const botId = 'st-17220bac-4b2e-5e1f-ab83-f8708ce87a8f';
    const jwtToken = 'mock-jwt-token';
  ...
  test('should handle clearing instances correctly', () => {
    const botId1 = 'st-17220bac-4b2e-5e1f-ab83-f8708ce87a8f';
    const botId2 = 'st-90549a67-7f19-5074-afcf-3120db51a26d';
    const jwtToken = 'mock-jwt-token';
