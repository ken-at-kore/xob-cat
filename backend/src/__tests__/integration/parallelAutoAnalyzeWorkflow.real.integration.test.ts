...
/**
 * PARALLEL AUTO-ANALYZE INTEGRATION TEST - REAL API VERSION
 * 
 * Tests the complete parallel auto-analysis workflow using real external APIs.
 ...
 * 
 * Usage Examples:
 * npm test -- --testPathPattern="parallelAutoAnalyzeWorkflow.real"                    # Basic test only
 * REAL_API_TEST_MODE=all npm test -- --testPathPattern="parallelAutoAnalyzeWorkflow.real"  # All tests
 * REAL_API_TEST_MODE=workflow npm test -- --testPathPattern="parallelAutoAnalyzeWorkflow.real"  # Workflow tests
 * 
 * # Test specific session counts (configurable) - 100 sessions tests parallel processing benefits
 * REAL_API_TEST_SESSION_COUNTS="100" REAL_API_TEST_MODE=workflow npm test -- --testPathPattern="parallelAutoAnalyzeWorkflow.real"
 ...
 */
describe('Parallel Auto-Analyze Integration Test - Real API', () => {
  ...
  beforeAll(() => {
    ...
    try {
      ...
      console.error('❌ [Parallel Real API Test] Missing required credentials:', (error as Error).message);
      console.log('💡 [Parallel Real API Test] Add the following to .env.local:');
    ...
    console.log('🔗 [Parallel Real API Test] Using real external APIs with parallel processing');
    console.log('🔗 [Parallel Real API Test] ServiceFactory type:', ServiceFactory.getServiceType());
    console.log(`🔗 [Parallel Real API Test] Test mode: ${testMode}`);
    console.log('💰 [Parallel Real API Test] WARNING: This test will incur OpenAI costs with parallel processing!');
