...
exports.CONTAINMENT_SUGGESTION_PROMPT = exports.DETAILED_ANALYSIS_PROMPT = exports.ANALYSIS_OVERVIEW_PROMPT = void 0;
exports.createAnalysisPrompt = createAnalysisPrompt;
exports.ANALYSIS_OVERVIEW_PROMPT = `
...
`;
exports.DETAILED_ANALYSIS_PROMPT = `
...
`;
exports.CONTAINMENT_SUGGESTION_PROMPT = `
...
`;
function createAnalysisPrompt(aggregation, sessions) {
    ...
    const calculateAnalysisPeriod = (sessions) => {
...
${transcript.messages.map(msg => `**${msg.message_type === 'user' ? 'User' : 'XO Bot'}**: ${msg.message}`).join('\n')}
`).join('\n')}
