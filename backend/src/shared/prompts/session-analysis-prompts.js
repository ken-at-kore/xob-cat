...
exports.CLASSIFICATION_INSTRUCTIONS = exports.SESSION_ANALYSIS_SYSTEM_MESSAGE = void 0;
exports.createSessionAnalysisPrompt = createSessionAnalysisPrompt;
exports.SESSION_ANALYSIS_SYSTEM_MESSAGE = 'You are an expert session analyst. Analyze the session transcripts and use the provided function to classify them consistently.';
exports.CLASSIFICATION_INSTRUCTIONS = `For each session, provide the following classifications:
...
function createSessionAnalysisPrompt(sessions, existingClassifications) {
    let intentGuidance = '';
...
${exports.CLASSIFICATION_INSTRUCTIONS}

${sessionsText}`;
}
//# sourceMappingURL=session-analysis-prompts.js.map